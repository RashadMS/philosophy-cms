...
export async function sendVerificationEmail(email, verificationToken, userName) {
  ...
  sendSmtpEmail.textContent = `مرحباً ${userName}،
...
© 2026 منصة رشاد`;
  ...
  try {
    ...
    console.log('From email:', sendSmtpEmail.sender.email);
    
    const response = await brevoClient.transactionalEmails.sendTransacEmail(sendSmtpEmail);
